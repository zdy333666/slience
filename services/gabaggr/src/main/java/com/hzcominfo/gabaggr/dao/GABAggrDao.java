...
import com.hzcominfo.gabaggr.util.XMLResultParser;
...
public class GABAggrDao {
     ...
     */
    public Map<String, String> fetch(String sessionId) throws DocumentException, Exception {

        //verifyInput(input);

        String resultStr =null;// GABInfoFetcher.fetch(input);
     ...
     * @throws org.dom4j.DocumentException
     */
    public List<Map<String, String>> fetchRows(SubmitInput input) throws DocumentException, Exception {
...
//     * @return
//     */
//    private void verifyInput(SubmitInput input) throws IllegalArgumentException {
//
