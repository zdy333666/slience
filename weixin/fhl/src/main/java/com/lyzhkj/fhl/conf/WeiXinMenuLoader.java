 ...
 */
@Component
public class WeiXinMenuLoader {

    private static final Logger LOGGER = LoggerFactory.getLogger(WeiXinMenuLoader.class);
...
//            stream.close();
//            WEIXIN_MENU_JSON = WEIXIN_MENU_JSON.replaceAll("http://www.domain.com", FHLConfig.APP_URL);
//
...
//        }
    ...
    public static WeiXinMenuButton initGroupOne() {
        ...
        WeiXinMenuButton sub_button_1 = new WeiXinMenuViewButton("分类知识库", "view", WeiXinUserUtil.getCodeRequest(FHLConfig.APP_URL + "/category-repository"));
        WeiXinMenuButton sub_button_2 = new WeiXinMenuViewButton("分类政策", "view", WeiXinUserUtil.getCodeRequest(FHLConfig.APP_URL + "/category-policy"));
    ...
    public static WeiXinMenuButton initGroupTwo() {
        ...
        button.setSub_button(new WeiXinMenuButton[]{sub_button_1, sub_button_2, sub_button_3, sub_button_4});
    ...
    public static WeiXinMenuButton initGroupThree() {
        ...
        //WeiXinMenuButton sub_button_2 = new WeiXinMenuViewButton("兑换查询", "view", WeiXinUserUtil.getCodeRequest(FHLConfig.APP_URL + "/exchange"));
