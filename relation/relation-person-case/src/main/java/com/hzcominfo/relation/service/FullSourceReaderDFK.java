...
//@Component
public class FullSourceReaderDFK {

	private Logger logger = LoggerFactory.getLogger(FullSourceReaderDFK.class);
    ...
    public FullSourceReaderDFK() {
        fields.put("_id", 0);
        fields.put("R_RYBH_SFZH", 1);
        fields.put("R_RYBH_XM", 1);
        fields.put("R_AJBH", 1);
        fields.put(sortField, 1);

        sort.put(sortField, 1);

        table = RelationConfiguration.mongo_dfk_source;
