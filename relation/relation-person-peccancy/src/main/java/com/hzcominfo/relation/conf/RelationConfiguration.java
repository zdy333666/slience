...
public class RelationConfiguration {
    ...
    public static String mongo_source;
    public static String link_table;
    ...
    static {
        try {
            ...
            mongo_source = props.getString("mongo_source");
            link_table=props.getString("link_table");
            
            kafka_source = props.getString("kafka_source");
