...
public class FullSourceReader {
    ...
    public FullSourceReader() {
        fields.put("_id", 0);
        fields.put("CERT_TYPE", 1);
        fields.put("CERT_NO", 1);
        fields.put("PSR_CHNNAME", 1);
        fields.put("PSR_NAME", 1);
        fields.put("FLT_NUM", 1);
        fields.put("PSR_SEATNBR", 1);
        fields.put("SEG_DEPT_CODE", 1);
        fields.put("SEG_DEST_CODE", 1);
        fields.put("FLT_DATE", 1);
